...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_GROUP_POSTING'						=> 'Notifications de publication de message',
	...
	'NOTIFICATION_TYPE_POST'							=> 'Quelqu’un a répondu à un sujet dans un forum que vous surveillez.',
	...
	'PROFILE_INFO_NOTICE'		=> 'Ces informations sont visibles par les autres membres. Soyez vigilant lors de la saisie d’informations personnelles. Les champs marqués par une * sont obligatoires.',
	'PROFILE_UPDATED'			=> 'Votre profil a été mis à jour.',
	'PROFILE_AUTOLOGIN_KEYS'	=> 'L’identifiant de session « Se souvenir de moi » vous connecte automatiquement quand vous accéder au forum. Si vous vous déconnectez, l’identifiant de session est supprimé seulement sur l’ordinateur à partir duquel vous vous êtes déconnecté. Ici, vous pouvez voir la liste des identifiants de session créés depuis les autres ordinateurs qui ont été utilisés pour accèder à ce forum.',
	...
	'UCP_NOTIFICATION_OPTIONS'			=> 'Modifier les préférences de notification',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Ici, vous pouvez définir comment vous serez alerté par les notifications que vous aurez sélectionnées.',
