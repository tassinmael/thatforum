...
$lang = array_merge($lang, array(
	...
	'DEFAULT_STYLE_EXPLAIN'			=> 'Défini le style par défaut pour les nouveaux membres.',
	...
	'GUEST_STYLE_EXPLAIN'			=> 'Défini le style par défaut pour les invités.',
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Si défini, un lien vers cette URL sera ajouté sur le fil d’Ariane et le logo. Ce lien redirigera vers cette page au lieu de renvoyer vers l’index du forum. Une URL absolue est requise, par exemple <samp>http://www.phpbb.com</samp>.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'Cela détermine si les utilisateurs ont accès au forum immédiatement ou si une confirmation est requise. Vous pouvez également désactiver complètement les nouvelles inscriptions. <em>« L’envoi d’e-mail » doit être autorisé afin de pouvoir choisir entre l’activation par l’utilisateur ou par l’administrateur.</em>',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Si désactivé, aucun e-mail ne sera envoyé par le forum. <em>Notez que les paramètres d’activation de compte « par l’utilisateur » ou « par l’administrateur » nécessitent que ce paramètre soit activé. Si l’activation de compte est définie sur « par l’utilisateur » ou « par l’administrateur », désactiver ce paramètre désactivera l’enregistrement de nouveaux membres.</em>',
