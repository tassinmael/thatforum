...
$lang = array_merge($lang, array(
	...
	'ALL_POSTS'						=> 'Tous',
	'ALL_TIMES'						=> 'Heures au format <abbr title="%2$s">%1$s</abbr>',
	'ALL_TOPICS'					=> 'Tous',
	'AND'							=> 'et',
	...
	'NOTIFICATION_ADMIN_ACTIVATE_USER'	=> '<strong>Activation de compte requise</strong> pour le nouveau membre : « %1$s ».',
	...
	'REG_USERS_ONLINE'			=> array(
		1	=> 'Il y a %1$d utilisateur enregistré et %2$s en ligne',
		2	=> 'Il y a %1$d utilisateurs enregistrés et %2$s en ligne',
	),
	...
	'REMOVE'					=> 'Supprimer',
	'REMOVE_INSTALL'			=> 'Pour finaliser l’installation du forum, supprimez, déplacez ou renommez le dossier install de votre espace FTP. Si ce dossier est toujours présent, seul le panneau d’administration (PCA) sera accessible.',
	'REPLIES'					=> 'Réponses',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Nous sommes désolés, mais vous n’êtes pas autorisé à utiliser cette fonctionnalité. Vous venez juste de vous enregistrer, et il est nécessaire de participer davantage pour utiliser cette fonctionnalité.',
